...
class RegularisationDetailsPageView extends StatefulWidget {
  final int id;
  final String token;

  const RegularisationDetailsPageView({
    super.key,
    required this.id,
    required this.token,
  });
  ...
  @override
  State<RegularisationDetailsPageView> createState() => _RegularisationDetailsPageViewState();
}

class _RegularisationDetailsPageViewState extends State<RegularisationDetailsPageView> {
  late RegularisationHistoryDetailsPageController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(RegularisationHistoryDetailsPageController());

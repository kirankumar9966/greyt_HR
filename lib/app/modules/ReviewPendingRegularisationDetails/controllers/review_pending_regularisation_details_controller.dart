...
class ReviewPendingRegularisationDetailsController extends GetxController {
  ...
  Future<void> fetchEmployeeName() async {
    final token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOi8vMTkyLjE2OC4xLjM4OjgwMDAvYXBpL2xvZ2luIiwiaWF0IjoxNzUwMDY1MDU1LCJleHAiOjE3NTAwNzIyNTUsIm5iZiI6MTc1MDA2NTA1NSwianRpIjoiVnlLUEg1UFFDOHlTUXExZSIsInN1YiI6IlhTUy0wMzA3IiwicHJ2IjoiMzRjNDhmOTlmOTNhZWI3Nzc4YjkyZGEyNWZkNTYyYTI2ODVjYjYyNiJ9.63s9DAf6KXVrdYowrxRg295ZwIOBPbIRBtK2w1NXOEI'; // Replace with your actual token
  ...
  Future<void> fetchRegularisationData(int id, String token) async {
    ...
    final url = Uri.parse('http://192.168.1.38:8000/api/showClosedRegRequests/$id');

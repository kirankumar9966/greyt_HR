...
import 'package:greyt_hr/app/modules/ReviewPendingRegularisationDetails/controllers/review_pending_regularisation_details_controller.dart';
import 'package:intl/intl.dart';



class ReviewPendingRegularisationDetailsView extends StatefulWidget {
  final int id;
  final String token;

  const ReviewPendingRegularisationDetailsView({
    super.key,
    required this.id,
    required this.token,
  });
  ...
  @override
  State<ReviewPendingRegularisationDetailsView> createState() => _ReviewPendingRegularisationDetailsViewState();
}

class _ReviewPendingRegularisationDetailsViewState extends State<ReviewPendingRegularisationDetailsView> {
  late ReviewPendingRegularisationDetailsController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(ReviewPendingRegularisationDetailsController());
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextField(
                            onChanged: (text) {
                              // Store the remark in a variable or a list if you're using this inside a loop
                              // Example: approverRemarks[index] = text;
                            },
        ...
        content: Column(
          ...
          children: [
            ...
            _buildTimelineRow(
              ...
              label: 'Submitted by $SubordinateName',
